/*
	...
	Updated to use NDS memory addresses
*/
...
//---------------------------------------------------------------------------------
{
	volatile u8 *sram= (u8*) 0x0A000000;
	volatile u16 x;
...
//---------------------------------------------------------------------------------
{
	volatile u8 *fctrl0 = (u8*) 0xA005555; 
	volatile u8 *fctrl1 = (u8*) 0xA002AAA; 
	volatile u8 *fctrl2 = (u8*) 0xA000000; 
